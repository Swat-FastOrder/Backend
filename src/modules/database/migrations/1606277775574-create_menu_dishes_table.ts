...
export class createMenuDishesTable1606277775574 implements MigrationInterface {
    name = 'createMenuDishesTable1606277775574'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "menu-dishes" ("id" SERIAL NOT NULL, "name" character varying(85) NOT NULL, "description" character varying(255) NOT NULL, "category_id" integer, "category_id" boolean NOT NULL, "disabled" boolean NOT NULL, "price" double precision NOT NULL, "image_url" character varying(255) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_1a1c0137df6b34f79deee94f4a9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "menu-dishes" DROP COLUMN "category_id"`);
        await queryRunner.query(`ALTER TABLE "menu-dishes" ADD "category_id" boolean NOT NULL`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "menu-dishes" DROP COLUMN "category_id"`);
        await queryRunner.query(`ALTER TABLE "menu-dishes" ADD "category_id" integer`);
        await queryRunner.query(`COMMENT ON COLUMN "menu_categories"."author_id" IS NULL`);
