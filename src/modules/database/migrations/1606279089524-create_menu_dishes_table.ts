...
export class createMenuDishesTable1606279089524 implements MigrationInterface {
    name = 'createMenuDishesTable1606279089524'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "menu-dishes" ("id" SERIAL NOT NULL, "name" character varying(85) NOT NULL, "description" character varying(255) NOT NULL, "category_id" integer, "is_recommended" boolean NOT NULL, "disabled" boolean NOT NULL, "price" double precision NOT NULL, "image_url" character varying(255) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_1a1c0137df6b34f79deee94f4a9" PRIMARY KEY ("id"))`);
